...
from Converters.chaseConverter import amazon_to_sql as amazon
# , united_to_sql as united, marriott_to_sql as marriott
    ...
    for file in files:
        with open(f"files/{file}", 'r') as f:
            ...
            for line in run(lines):
                output.write(f"INSERT INTO Transactions (ActualDate, Description, Category, Account, Amount, Tags) VALUES ('{line[0]}', '{line[1]}', 'Unsorted', '{line[2]}', {line[3]}, '');\n")